...
- 🏢 550 US & European investment grade companies (ticker auto-fill)
- ✅ Green/red screen flash feedback on answers
- 📩 Microsoft Forms lead capture
- 📋 Game start logging to Google Sheets
- 📱 Mobile friendly
...
| File | Description |
|---|---|
| `index.html` | The complete game (single file, ~160KB) |
| `README.md` | This file |
